...
export const createCategory = createAction('CREATE_CATEGORY', (organizationId, data) => ({ organizationId, data }),
...
export const updateCategory = createAction('UPDATE_CATEGORY', (organizationId, categoryId, data) => ({ organizationId, categoryId, data }),
  (_organizationId, _data, resolve = noop, reject = noop) => ({ resolve, reject }));
