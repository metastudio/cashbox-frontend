...
export const updateMemberLastVisit = createAction(
  'UPDATE_MEMBER_LAST_VISIT',
  (organizationId) => ({ organizationId }),
  (_organizationId, _memberId, resolve = noop, reject = noop) => ({ resolve, reject }),
);
updateMemberLastVisit.request = createAction(
  'UPDATE_MEMBER_LAST_VISIT_REQUEST',
  (organizationId) => ({ organizationId }),
);
updateMemberLastVisit.success = createAction(
  'UPDATE_MEMBER_LAST_VISIT_SUCCESS',
  (organizationId, member) => ({ organizationId, member }),
);
