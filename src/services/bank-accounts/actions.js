...
export const updateBankAccount = createAction('UPDATE_BANK_ACCOUNT', (organizationId, bankAccountId, data) => ({ organizationId, bankAccountId, data }), (_organizationId, _data, resolve = noop, reject = noop) => ({ resolve, reject }));
updateBankAccount.request = createAction('UPDATE_BANK_ACCOUNT_REQUEST', (organizationId, bankAccountId) => ({ organizationId, bankAccountId }));
