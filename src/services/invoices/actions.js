...
loadInvoices.request = createAction(
  'LOAD_INVOICES_REQUEST',
  (organizationId) => ({ organizationId }),
);
loadInvoices.success = createAction(
  'LOAD_INVOICES_SUCCESS',
  (organizationId, invoices, pagination) => ({ organizationId, invoices, pagination }),
);
loadInvoices.failure = createAction('LOAD_INVOICES_FAILURE');

export const loadUnpaidInvoices = createAction(
  'LOAD_UNPAID_INVOICES',
  (organizationId, params) => ({ organizationId, params }),
);
loadUnpaidInvoices.request = createAction(
  'LOAD_UNPAID_INVOICES_REQUEST',
  (organizationId) => ({ organizationId }),
);
loadUnpaidInvoices.success = createAction(
  'LOAD_UNPAID_INVOICES_SUCCESS',
  (organizationId, invoices, pagination) => ({ organizationId, invoices, pagination }),
);
loadUnpaidInvoices.failure = createAction('LOAD_UNPAID_INVOICES_FAILURE');

export const loadUnpaidInvoicesCount = createAction(
  'LOAD_UNPAID_INVOICES_COUNT',
  (organizationId) => ({ organizationId }),
);
loadUnpaidInvoicesCount.request = createAction(
  'LOAD_UNPAID_INVOICES_COUNT_REQUEST',
  (organizationId) => ({ organizationId }),
);
loadUnpaidInvoicesCount.success = createAction(
  'LOAD_UNPAID_INVOICES_COUNT_SUCCESS',
  (organizationId, unpaidCount) => ({ organizationId, unpaidCount }),
);
...
createInvoice.request = createAction(
  'CREATE_INVOICE_REQUEST',
  (organizationId) => ({ organizationId }),
);
createInvoice.success = createAction(
...
export const destroyInvoice = createAction(
  'DESTROY_INVOICE',
  (organizationId, invoiceId) => ({ organizationId, invoiceId }),
  (_organizationId, _invoiceId, resolve = noop, reject = noop) => ({ resolve, reject }),
);
destroyInvoice.request = createAction(
  'DESTROY_INVOICE_REQUEST',
  (organizationId) => ({ organizationId }),
);
destroyInvoice.success = createAction(
...
downloadInvoicePDF.request = createAction(
  'DOWNLOAD_INVOICE_PDF_REQUEST',
  (organizationId, invoiceId) => ({ organizationId, invoiceId }),
);
downloadInvoicePDF.success = createAction(
  'DOWNLOAD_INVOICE_PDF_SUCCESS',
  (organizationId, pdf) => ({ organizationId, pdf }),
);
downloadInvoicePDF.failure = createAction('DOWNLOAD_INVOICE_PDF_FAILURE');

export const updateInvoice = createAction(
  'UPDATE_INVOICE',
  (organizationId, invoiceId, data) => ({ organizationId, invoiceId, data }),
  (_organizationId, _invoiceId, _data, resolve = noop, reject = noop) => ({ resolve, reject }),
);
updateInvoice.request = createAction(
  'UPDATE_INVOICE_REQUEST',
  (organizationId) => ({ organizationId }),
);
updateInvoice.success = createAction(
