...
loadCustomers.request = createAction(
  'LOAD_CUSTOMERS_REQUEST',
  (organizationId) => ({ organizationId }),
);
loadCustomers.success = createAction(
  'LOAD_CUSTOMERS_SUCCESS',
  (organizationId, customers) => ({ organizationId, customers }),
);
...
createCustomer.request = createAction(
  'CREATE_CUSTOMER_REQUEST',
  (organizationId) => ({ organizationId }),
);
createCustomer.success = createAction(
...
export const loadCustomer = createAction(
  'LOAD_CUSTOMER',
  (organizationId, customerId) => ({ organizationId, customerId }),
);
loadCustomer.request = createAction(
  'LOAD_CUSTOMER_REQUEST',
  (organizationId, customerId) => ({ organizationId, customerId }),
);
loadCustomer.success = createAction(
...
updateCustomer.success = createAction(
...
export const deleteCustomer = createAction(
  'DELETE_CUSTOMER',
  (organizationId, customerId) => ({ organizationId, customerId }),
  (_organizationId, _customerId, resolve = noop, reject = noop) => ({ resolve, reject }),
);
deleteCustomer.request = createAction(
  'DELETE_CUSTOMER_REQUEST',
  (organizationId, customerId) => ({ organizationId, customerId }),
);
deleteCustomer.success = createAction(
