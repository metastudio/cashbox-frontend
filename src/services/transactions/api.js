import { prepareURL, getApi, postApi, patchApi, deleteApi } from 'utils/api-helpers';
...
const transactionUrl  = (orgId, transactionId) => {
...
export const patchOrganizationTransaction  = (orgId, transactionId, data) => {
  return patchApi(transactionUrl(orgId, transactionId), { transaction: data });
};
