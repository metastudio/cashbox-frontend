...
class NewExpenseTransaction extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return(
      <Form onSubmit={ this.handleSubmit } onSubmitSuccess={ this.afterCreate } orgId={ this.props.orgId } type="Expense" action="Create" />
    );
  }
}

NewExpenseTransaction.propTypes = {
...
export default withRouter(connect(select, dispatcher)(NewExpenseTransaction));
